...
public typealias intIndex = Int
public typealias Closure = () -> Void
public typealias SelectionClosure = (intIndex, String) -> Void
public typealias MultiSelectionClosure = ([intIndex], [String]) -> Void
public typealias ConfigurationClosure = (intIndex, String) -> String
public typealias CellConfigurationClosure = (intIndex, String, DropDownCell) -> Void
...
public final class DropDown: UIView {
	...
	*/
	@objc public dynamic var shadowColorDropDown = DPDConstant.UI.Shadow.Color {
	...
	Changing the shadow color automatically reloads the drop down.
	*/
	@objc public dynamic var shadowOffsetDropDown = DPDConstant.UI.Shadow.Offset {
	...
	*/
	@objc public dynamic var shadowOpacityDropDown = DPDConstant.UI.Shadow.Opacity {
	...
	*/
	@objc public dynamic var shadowRadiusDropDown = DPDConstant.UI.Shadow.Radius {
	...
	*/
    ...
    public var selectedRowIndices = Set<intIndex>()
...
private extension DropDown {
	...
	func setupUI() {
		...
		tableViewContainer.layer.shadowColor = shadowColorDropDown.cgColor
...
//        tableView.layer.borderColor = VBColorEnum.BorderColor.getColor().cgColor
...
extension DropDown {
	...
	*/
	...
	public func selectRow(at index: intIndex?) {
		if let index = index {
            tableView.selectRow(
    ...
    public func selectRows(at indices: Set<intIndex>?) {
        indices?.forEach {
            selectRow(at: $0)
        }
	...
	public func deselectRow(at index: intIndex?) {
    ...
    public func deselectRows(at indices: Set<intIndex>?) {
        indices?.forEach {
            deselectRow(at: $0)
        }
    }
	...
	public var indexForSelectedRow: intIndex? {
    ...
    @objc public func selectRow(_ index: Int) {
        self.selectRow(at:intIndex(index))
    }
    ...
    @objc public func deselectRow(_ index: Int) {
        tableView.deselectRow(at: IndexPath(row: intIndex(index), section: 0), animated: true)
    }

...
struct TasksScreenModel : Codable {
    let rows : [TasksScreenData]?
    let pages : Int?
    ...
    init(from decoder: Decoder) throws {
        ...
        rows = try values.decodeIfPresent([TasksScreenData].self, forKey: .rows)
        pages = try values.decodeIfPresent(Int.self, forKey: .pages)
    }
}


struct TasksScreenData : Codable {
    let id : Int?
    let status : String?
    let client_id : Int?
    let project_id : Int?
...
//    let assigned_users : [Int]?
    ...
    enum CodingKeys: String, CodingKey {
        ...
        case task_template_id = "task_template_id"
...
//        case assigned_users = "assigned_users"
    ...
    init(from decoder: Decoder) throws {
        ...
        data = try values.decodeIfPresent(TaskSelectData.self, forKey: .data)
        ...
        task_template_id = try values.decodeIfPresent(String.self, forKey: .task_template_id)
